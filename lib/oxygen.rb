...
module Oxygen
  ...
  # Calculate a media value for oxygen production;
  ...
  # Evaluate the amount of oxygen produced by the amount of unique values
  ...
  # Evaluate oxygen production of seaweed;
